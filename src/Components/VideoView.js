...
export default function VideoView() {
    ...
    //     }
    // }
let url = 'https://cdn.dnaindia.com/sites/default/files/styles/full/public/1545128.jpg'
        ...
        <div className="max-w-screen-xl mx-auto mt-40 ">
            ...
            <div className=" h-[600px] p-10 flex items-end relative bg-center bg-cover" style={{backgroundImage: `url(${url})`}}>
                ...
                <div className="gap-4">
                    ...
                    <h2 className="inline-flex text-5xl text-black bg-yellow-300 font-bold">{listTv[index].name}</h2>
                    <p className="block text-black bg-yellow-300 font-bold mt-2">{listTv[index].overview}</p>
                </div>
