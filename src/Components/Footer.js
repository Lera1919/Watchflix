            ...
            <div className="bg-grey-900 ">
                    <div className="max-w-screen-xl mx-auto grid grid-cols-3">
                        <div className='py-28'>
                            ...
                            <p className='text-base text-grey-300 mt-8'>Lorem ipsum dolor sit amet, consec tetur adipis cing elit, sed do eiusmod tempor incididunt ut labore et.</p>
                            ...
                            <div className='px-16 py-28 col-span-2'>
                                ...
                                <div className='flex gap-4 mt-24'>
                                    <span className='flex gap-1 items-center'> <MapPinIcon className="h-4 w-4"/>8819 Ohio St. South Gate, California 90280</span>
                                    <span className='flex gap-1 items-center'> <AtSymbolIcon className="h-4 w-4"/>ourstudio@hello.com</span>
                                    <span className='flex gap-1 items-center'> <PhoneIcon className="h-4 w-4"/>+271 386-647-3637</span>
                                    </div>
                            </div>         
                    </div>
            </div>
